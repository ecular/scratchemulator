...
{
    universal_reg_ax = (universal_reg_ax & 0x00FF) | (((uint16_t)value & 0x00FF) << 8);
}
...
{
    universal_reg_bx = (universal_reg_bx & 0x00FF) | (((uint16_t)value & 0x00FF) << 8);
}
...
{
    universal_reg_cx = (universal_reg_cx & 0x00FF) | (((uint16_t)value & 0x00FF) << 8);
}
...
{
    universal_reg_dx = (universal_reg_dx & 0x00FF) | (((uint16_t)value & 0x00FF) << 8);
}
...
{
    return (uint8_t)universal_reg_ax;
}
...
{
    return (uint8_t)universal_reg_bx;
}
...
{
    return (uint8_t)universal_reg_cx;
}
...
{
    return (uint8_t)universal_reg_dx;
}
